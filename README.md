...
After downloading the necessary files follow this [guide](chessparov/chessparov/main/python-setup.md) on how to install python and all the necessary packages.
